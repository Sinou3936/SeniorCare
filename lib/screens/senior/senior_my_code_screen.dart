  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<String>(
        future: FirestoreService.getSeniorCode(),
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                const Icon(Icons.qr_code_rounded, size: 64, color: Color(0xFF4A90D9)),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text(
                '카카오톡으로 공유',
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF3A1D1D)),
              ),
            ),
          ),
          const SizedBox(height: 16),
