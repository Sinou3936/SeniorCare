    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Î≥ëÏõê ?¥Î¶Ñ', style: TextStyle(fontSize: 18, color: Color(0xFF666666))),
            ...
            const Text('?†Ïßú', style: TextStyle(fontSize: 18, color: Color(0xFF666666))),
            const SizedBox(height: 8),
            GestureDetector(
              onTap: _pickDate,
              child: Container(
            ...
            const SizedBox(height: 24),
            const Text('?úÍ∞Ñ', style: TextStyle(fontSize: 18, color: Color(0xFF666666))),
            const SizedBox(height: 8),
            Container(
            ...
            const SizedBox(height: 24),
            const Text('Î©îÎ™® (?†ÌÉù)', style: TextStyle(fontSize: 18, color: Color(0xFF666666))),
            const SizedBox(height: 8),
            TextField(
