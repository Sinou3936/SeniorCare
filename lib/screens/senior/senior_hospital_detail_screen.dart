  ...
  Future<void> _confirmDelete(BuildContext context) async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        title: const Text('?ˆì•½ ?? œ', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
        content: Text(
          '${appointment.hospitalName} ?ˆì•½???? œ? ê¹Œ??',
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text('?? œ', style: TextStyle(fontSize: 18, color: Color(0xFFE53935))),
          ),
        ],
      ),
    );
